...
<head>
	...
	<script type="text/javascript">
		$.ajaxSetup({
			headers: {
				'X-CSRF-TOKEN': 'jRYTEIQHTRK3E4WhxvSgnZnYhIjoaYUqGr3q8W3X'
			}
		});
	</script>
	<script type="text/javascript">
...
<body>
	...
	<div class="col-banner">
		<div class="banner-border" style="border:0px;">
			<div class="inner-border" style="border:0px;">
				<script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1505511952227201"
					crossorigin="anonymous"></script>
				<!-- Footer ad left -->
